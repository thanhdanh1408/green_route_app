            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Thông tin xe của bạn', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                    const SizedBox(height: 12),
                    Row(
                      children: [
                        const Icon(Icons.local_shipping, color: AppColors.primary),
                        const SizedBox(width: 8),
                        Text('Biển số xe: $_licensePlate', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text('Loại xe: $_vehicleType', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                    const SizedBox(height: 8),
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text('Tải trọng tối đa: $_maxLoad', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ],
                ),
              ...
              const Text('Điểm xuất phát *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              DropdownButtonFormField<String>(
                ...
                items: provinceOptions.map((p) => DropdownMenuItem(value: p, child: Text(p))).toList(),
                onChanged: (value) => setState(() => _selectedFrom = value),
                validator: (value) => value == null ? 'Chọn điểm xuất phát' : null,
              ),
              const SizedBox(height: 16),

              const Text('Địa chỉ nhận hàng *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'Nhập địa chỉ nhận hàng' : null,
              ),
              const SizedBox(height: 16),

              const Text('Điểm đến *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              DropdownButtonFormField<String>(
                value: _selectedTo,
                decoration: InputDecoration(
              ...
              const Text('Địa chỉ giao hàng *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'Nhập địa chỉ giao hàng' : null,
              ),
              const SizedBox(height: 16),

              // Ngày giờ khởi hành
              const Text('Ngày giờ khởi hành *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              InkWell(
                    ...
                    children: [
                      ...
                      Text(
                        _pickupTime == null
                            ...
                            : DateFormat('dd/MM/yyyy HH:mm').format(_pickupTime!),
                        style: TextStyle(color: _pickupTime == null ? Colors.grey : Colors.black),
                      ),
                    ],
                  ),
                ),
              ...
              // Ngày giờ giao hàng
              const Text('Ngày giờ giao hàng *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              InkWell(
                    ...
                    children: [
                      ...
                      Text(
                        _deliveryTime == null
                            ...
                            : DateFormat('dd/MM/yyyy HH:mm').format(_deliveryTime!),
                        style: TextStyle(color: _deliveryTime == null ? Colors.grey : Colors.black),
                      ),
                    ],
                  ),
                ),
              ...
              const Text('Tổng giá cước đề xuất (VNĐ) *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              TextFormField(
                ...
                validator: (value) => value == null || value.isEmpty ? 'Nhập giá cước' : null,
              ),
              const SizedBox(height: 16),

              // Số người tham gia tối đa
              const Text('Số chủ hàng tối đa *', style: TextStyle(fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              DropdownButtonFormField<String>(
                value: _maxShippers,
                decoration: InputDecoration(
                ...
                items: shipperOptions.map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
                ...
                child: CustomButton(
                  ...
                  onPressed: () async {
                    if (_formKey.currentState!.validate() && _pickupTime != null && _deliveryTime != null) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Vui lòng chọn ngày giờ khởi hành và giao hàng'),
